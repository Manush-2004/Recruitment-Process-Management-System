    ...
    <div className="max-w-5xl mx-auto py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white p-4 rounded shadow">
          ...
          <button
            onClick={() => exportCsv(position, "position_report.csv")}
            className="px-3 py-1 bg-gray-100 rounded mb-2"
          >
            Export CSV
          </button>
          <ul>
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          <button
            onClick={() => exportCsv(tech, "technology_report.csv")}
            className="px-3 py-1 bg-gray-100 rounded mb-2"
          >
            Export CSV
          </button>
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          <pre className="text-sm">
            {JSON.stringify(interviewerSummary, null, 2)}
          </pre>
        </div>
      </div>
    </div>
