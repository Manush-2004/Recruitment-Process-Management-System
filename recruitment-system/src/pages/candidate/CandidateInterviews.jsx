...
import { getMyInterviews } from "../../services/candidatesService";
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium">
                      {iv.roundType ?? iv.round_type} —{" "}
                      {iv.job?.title ?? iv.job?.Title}
                    </p>
                    <p className="text-sm text-ds-text-secondary">
                      {new Date(
                        iv.scheduledAt ?? iv.scheduled_at,
                      ).toLocaleString()}
                    </p>
                    <p className="text-sm text-ds-text-secondary">
                      Mode: {iv.mode ?? iv.mode}{" "}
                      {iv.meetingLink && (
                        <a
                          href={iv.meetingLink ?? iv.meeting_link}
                          className="text-ds-primary ml-2"
                        >
                          Join
                        </a>
                      )}
